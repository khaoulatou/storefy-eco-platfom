      ...
      <div class="col-md-4">
        <div class="card">
          <div class="img-container">
            ...
            <img src="https://i.imgur.com/gGyOciQ.jpg" class="img-fluid" />
          </div>
          <div class="product-detail-container">
            <div class="d-flex justify-content-between align-items-center">
              <h6 class="mb-0">Black top caps</h6>
              <span class="text-danger font-weight-bold">$1.99</span>
            </div>
            <div class="d-flex justify-content-between align-items-center mt-2">
              <div class="ratings">
                <i class="fa fa-star"></i> <span>4.5</span>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="img-container">
            ...
            <img src="https://i.imgur.com/3VuD1Ij.jpg" class="img-fluid" />
          </div>
          <div class="product-detail-container">
            <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="img-container">
            ...
            <img src="https://i.imgur.com/psvQPza.jpg" class="img-fluid" />
          </div>
          <div class="product-detail-container">
            <div class="d-flex justify-content-between align-items-center">
              <h6 class="mb-0">Long red shirt</h6>
              <span class="text-danger font-weight-bold">$4.99</span>
            </div>
            <div class="d-flex justify-content-between align-items-center mt-2">
              <div class="ratings">
                <i class="fa fa-star"></i> <span>4.5</span>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="img-container">
            ...
            <img src="https://i.imgur.com/5l1bL3Y.jpg" class="img-fluid" />
          </div>
          <div class="product-detail-container">
            <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
              ...
              <div class="size">
                <label class="radio">
                  <input type="radio" name="size5" value="small" />
                  <span>S</span>
                </label>
                <label class="radio">
                  <input type="radio" name="size5" value="Medium" checked />
                  <span>M</span>
                </label>
                <label class="radio">
                  <input type="radio" name="size5" value="Large" />
                  <span>L</span>
                </label>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="img-container">
            ...
            <img src="https://i.imgur.com/9StAn6x.jpg" class="img-fluid" />
          </div>
          <div class="product-detail-container">
            <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
              ...
              <div class="size">
                <label class="radio">
                  <input type="radio" name="size6" value="small" />
                  <span>S</span>
                </label>
                <label class="radio">
                  <input type="radio" name="size6" value="Medium" checked />
                  <span>M</span>
                </label>
                <label class="radio">
                  <input type="radio" name="size6" value="Large" />
                  <span>L</span>
                </label>
              </div>
            </div>
